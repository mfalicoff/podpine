...
- Persistent mini-player and full player
- Seek, skip intervals, playback speed, and periodic position persistence
- Secure credential storage
- Demo library for development and product review

The current player uses `just_audio`. Platform lock-screen integration, background media controls, production downloads, automatic-download rules, Pinepods discovery/subscribe flows, queue reordering, and background refresh scheduling remain follow-up work. See [Architecture](docs/ARCHITECTURE.md).
